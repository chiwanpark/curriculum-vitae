...
\begin{minipage}[t]{0.6\textwidth}
  \vspace{0pt}
  Machine Learning Engineer at NAVER Cloud\\
...
\begin{entry}
\item \textbf{Post-Training of Language Models:} developing techniques to enhance the various capabilities of language models by making post-training environments scalable.
...
\begin{entry}
  ...
  \item \textbf{Machine Learning Engineer} at NAVER Cloud\hfill\textsc{Dec. 2025 -- Present}
  \begin{itemize}
    \item To be updated soon.
  \end{itemize}
  \item \textbf{Applied Machine Learning Engineer} at Kakao\hfill\textsc{Apr. 2018 -- Dec. 2025}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Performed extensive evaluations of various language models in terms of their agentic capabilities in real-world scenarios, including task accuracy, output format adherence, and response quality.
      ...
      \item Co-authored and published research papers at \href{https://arxiv.org/abs/2505.23006}{ACL 2025 (Industry Track)} and \href{https://openreview.net/forum?id=Oljnxmf4pc}{ICLR 2026}.
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item Led research initiaitives that resulted in presentations at various academic and industrial venues, including \href{https://dl.acm.org/doi/10.1145/3556702.3556851}{RecSys'22 Challenge}, \href{https://amazonkddcup.github.io/papers/0620.pdf}{KDD Cup'22}, \href{https://speakerdeck.com/chiwanpark/challenges-in-real-world-recommender-systems}{KCC 2022}, \href{https://dl.acm.org/doi/10.1145/3539618.3591934}{SIGIR'23}, and multiple if(kakao) events (\href{https://if.kakao.com/2019/program?sessionId=dce0dd84-d054-4b80-8013-b3d58f61bbe8}{2019}, \href{https://if.kakao.com/2020/session/125}{2020}, \href{https://if.kakao.com/2021/session/27}{2021}, \href{https://if.kakao.com/2022/session/8}{2022}).
    \end{itemize}
    \item Contributed to the recruitment process, conducting 80+ interviews and operating internship programs.
    \begin{itemize}
      \item Designed and operated a team-level internship program that was later adopted as the foundation for Kakao's company-wide internship program.
    \end{itemize}
  \end{itemize}
\end{entry}
...
\begin{entry}
  \item \textbf{OrchestrationBench: LLM-Driven Agentic Planning and Tool Use in Multi-Domain Scenarios}\\
  Aelim Ahn, Sooyeon Lee, Hyosun Wang, \underline{Chiwan Park}, Daeryong Kim, Jihyeon Roh, Kichang Yang, Wonjun Jang, Hwang Woosung, Min Seok Kim, and Jihoon Kang\\
